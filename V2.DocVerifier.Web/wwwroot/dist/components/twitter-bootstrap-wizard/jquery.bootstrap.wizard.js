...
; (function ($) {
    var bootstrapWizardCreate = function (element, options) {
        ...
        this.fixNavigationButtons = function () {
            ...
            $($settings.previousSelector, element).toggleClass('d-none', (obj.firstIndex() >= obj.currentIndex()));
            ...
            $($settings.backSelector, element).toggleClass('d-none', (historyStack.length == 0));
        ...
        this.show = function (index) {
            ...
            if (tabToShow.length > 0) {
                for (var i = obj.currentIndex(); i < index; i++) {
                    historyStack.push(i);
                }
                //tabToShow.tab('show');
                $navigation.find(baseItemSelector + ($settings.withVisible ? ':visible' : '') + ':eq(' + index + ') a').tab('show');
